...
class ItemDB
{
    ...
    public Item a000;
    public Item a001 = new Item("초심자의 검", "모두에게 기본으로 지급되는 검이다", 1, 3);
    public Item a002 = new Item("초심자의 갑옷", "모두에게 기본으로 지급되는 갑옷이다", 2, 3);

    public Item a003 = new Item("중급자 검", "아무래도 초급자 겁보다는 강해보인다", 1, 5);
